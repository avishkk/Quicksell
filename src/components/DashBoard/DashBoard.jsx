            ...
            <div key={index} className="dashCardContainer" style={{ width: `${cardWidthPercentage}%` }}>
              <div className="dashCardHeading flex-sb">
                <div className="leftView">
                  {user ? (
                    <div className="imageContainer relative" style={{ width: "10px", height: "15px", display: "inline-block" }}>
                ...
                <div className="rightView">
                  <img src={addimg} alt="Add" style={{ width: "16px", height: "16px" }} />
              ...
              <div className="dashList flex-gap-10">
                {element[index]?.value?.map((el, ind) => (
                  <Card
                    key={el.id || ind}  // Ensure each card has a unique key
                    id={el.id}
                    title={el.title}
                    tag={el.tag}
                    status={el.status}
